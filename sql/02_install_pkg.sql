...
-- =================================================================
-- the dbsrc_mgr package
-- =================================================================

-- =================================================================
-- PRIVILEGE NOTE:
-- This package requires select_catalog_role role (hardcoded req for
-- dbms_metadata) for background, see "How To Retrieve The Full Object
-- Definition (DDL) From The Database (Doc ID 1460969.1)"
-- =================================================================

drop package dbsrc_mgr;
create or replace package dbsrc_mgr authid current_user as
-- ============================================================================
--    Copyright 2019 Steve Rutledge
-- =========================================================================
--    This package is part of DBSRC Librarian.
--
...
create or replace package body dbsrc_mgr as
    --
    -- ============================================================
    -- ============================================================
    -- PRIVATE

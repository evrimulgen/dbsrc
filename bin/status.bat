...
:: report a brief status summarizing the contents of the dbsrc table
(
echo @@sql/_init_interactive
echo exec dbsrc_mgr.stat;
echo exit;
) | sqlplus -s %dbsrc_user%/%dbsrc_pw%@%dbsrc_db%
goto end

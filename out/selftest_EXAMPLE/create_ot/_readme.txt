...
-- DESCRIPTION
--
-- These are database scripts for each owner and type in the selftest dbsrc
-- configuration. DDL is arranged in dependency order inside each script.
--
-- Explicitly grouping ddl by owner and type will of course violate build
-- dependencies, so don't expect to be able to execute these scripts without
-- errors.
--
-- ============================================================================
-- ========================================================================

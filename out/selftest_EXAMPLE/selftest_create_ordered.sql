...
-- DESCRIPTION
--
-- The intent of this script is for it to be readable by human beings,
-- so objects are grouped and arranged in a logical order intended for
-- mere humans to find useful. In this script, ddl objects are grouped
-- by type. The order of types is based on dbsrc_cfg.dbscript.order_no
-- for this cfg_name, which is typically alphabetic order.
--
-- Explicitly grouping ddl by type will of course destroy the build
-- dependencies, so don't even try to execute this script.
--
-- ============================================================================
-- ========================================================================
...
select 'selftest_1000_create_ordered_'||to_char(sysdate,'YYYYMMDD_HH24MISS')||'.log' logfile from dual;
spool &v_logfile
...
-- ====================================================================
-- Users
-- WARNING: passwords are reset to "password"
-- ====================================================================
